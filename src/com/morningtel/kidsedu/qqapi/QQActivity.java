...
public class QQActivity extends Activity {
	...
	private class BaseUiListener implements IUiListener {
		...
		public void onComplete(JSONObject response) {
			CommonUtils.showCustomToast(QQActivity.this, "登录成功");
			System.out.println(response.toString());
			doComplete(response);
		}
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                tencent.shareToQQ(activity, params, new IUiListener() {
                    ...
                    public void onComplete(JSONObject response) {
                        // TODO Auto-generated method stub
                        CommonUtils.showCustomToast(activity, "分享成功");
                        finish();
                    }

                    @Override
                    public void onError(UiError e) {
                        CommonUtils.showCustomToast(activity, "分享失败"+e.errorMessage);
                        finish();
                    }
                    ...
                    public void onCancel() {
                    	if(shareType!=Tencent.SHARE_TO_QQ_TYPE_IMAGE){
                    		CommonUtils.showCustomToast(activity, "分享取消");
                    		finish();
                    	}
                    }
	...
	private class TQQApiListener extends BaseApiListener {
        ...
        public void onIOException(final IOException e, Object state) {
            CommonUtils.showCustomToast(QQActivity.this, "分享失败，onIOException: "+e.getMessage());
            finish();
        }
        ...
        public void onMalformedURLException(final MalformedURLException e,
                Object state) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onMalformedURLException: "+e.getMessage());
        	finish();
        }

        @Override
        public void onJSONException(final JSONException e, Object state) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onJSONException: "+e.getMessage());
        	finish();
        }
        ...
        public void onConnectTimeoutException(ConnectTimeoutException e,
                Object arg1) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onConnectTimeoutException: "+e.getMessage());
        	finish();
        }
        ...
        public void onSocketTimeoutException(SocketTimeoutException e,
                Object arg1) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onSocketTimeoutException: "+e.getMessage());
        	finish();
        }

        @Override
        public void onUnknowException(Exception e, Object arg1) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onUnknowException: "+e.getMessage());
        	finish();
        }

        @Override
        public void onHttpStatusException(HttpStatusException e, Object arg1) {
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onHttpStatusException: "+e.getMessage());
        	finish();
        }
        ...
        public void onNetworkUnavailableException(
        	...
        	CommonUtils.showCustomToast(QQActivity.this, "分享失败，onNetworkUnavailableException: "+e.getMessage());
        	finish();
        }
	}
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(response!=null) {
				...
				CommonUtils.showCustomToast(QQActivity.this, "分享成功");
