...
public class AccountVideoAdapter extends BaseAdapter {
	...
	public AccountVideoAdapter(ArrayList<AppModel> model_list, Context context, OnRefreshListener lis) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Account_VideoList_Holder holder=null;
		if(convertView==null) {
			holder=new Account_VideoList_Holder();
			...
			holder=(Account_VideoList_Holder)convertView.getTag();
		}
		...
		holder.button_remove.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Conn.getInstance(context).deleteAppModel(model_list.get(position_).getName(), "video");
				Conn.getInstance(context).deleteOtherPlatformByVideo(model_list.get(position_).getId());
...
class Account_VideoList_Holder {
