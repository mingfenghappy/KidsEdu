...
public class AppTabsActivity extends FragmentActivity {
    ...
    public void loadAppTypesByRid() {
    	final Handler handler=new Handler() {
    		...
    		public void handleMessage(Message msg) {
    			...
    			if(msg.obj==null) {
    				CommonUtils.showCustomToast(AppTabsActivity.this, "网络异常，请稍后再试");
				}
				else {
					...
					if(CommonUtils.convertNull(str).equals("")) {
						...
						if(app_types_list_temp.size()==0) {
							CommonUtils.showCustomToast(AppTabsActivity.this, "暂无相关信息");
						}
						else {
    ...
    class AppListAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return AppFragment.newInstance(app_types_list.get(position).getId());
        }
