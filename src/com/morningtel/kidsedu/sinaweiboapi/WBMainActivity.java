...
public class WBMainActivity extends Activity implements IWeiboHandler.Response {
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (mAccessToken.isSessionValid()) {
            	...
            	CommonUtils.showCustomToast(WBMainActivity.this, "授权成功");
            	sendBefore();
            } else {
                // 当您注册的应用程序签名不正确时，就会收到 Code，请确保签名正确
                String code=values.getString("code");
                CommonUtils.showCustomToast(WBMainActivity.this, "授权失败\nObtained the code: " + code);
                finish();
            }
        }
        ...
        public void onCancel() {
        	CommonUtils.showCustomToast(WBMainActivity.this, "取消授权");
        	finish();
        }
    ...
    private void sendBefore() {
        ...
        if(!mWeiboShareAPI.isWeiboAppInstalled()) {
            mWeiboShareAPI.registerWeiboDownloadListener(new IWeiboDownloadListener() {
                @Override
                public void onCancel() {
                    CommonUtils.showCustomToast(WBMainActivity.this, "取消下载");
                }
            });
        }
    ...
    private void sendMessage() {        
        if (mWeiboShareAPI.isWeiboAppSupportAPI()) {
            ...
            CommonUtils.showCustomToast(WBMainActivity.this, "微博客户端不支持SDK分享或微博客户端未安装或微博客户端是非官方版本。");
        }
    }
    ...
    public void onResponse(BaseResponse baseResp) {
        ...
        case WBConstants.ErrorCode.ERR_OK:
            CommonUtils.showCustomToast(WBMainActivity.this, "分享成功");
            break;
        case WBConstants.ErrorCode.ERR_CANCEL:
        	CommonUtils.showCustomToast(WBMainActivity.this, "取消分享");
            break;
